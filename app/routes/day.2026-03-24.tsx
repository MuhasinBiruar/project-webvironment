        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="prose prose-green max-w-none">
            <p className="text-gray-800 mb-4">
              I noticed a discarded 7/11 GULP cup left behind in the classroom.
            ...
            <p className="text-gray-800">
              ...
              encountered during this task. However, identifying the correct
              waste categories required a bit of attention to ensure proper
              segregation.
            </p>
            <p className="text-gray-800 mt-4">
              <strong>Next Steps:</strong> Continue practicing and promoting
              proper waste segregation. Encourage classmates to be more mindful
              of their trash disposal habits to help maintain a cleaner
              environment.
            </p>
          </div>
        </div>
