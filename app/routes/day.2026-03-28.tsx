      ...
      <div className="max-w-5xl mx-auto p-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-green-800 mb-4">
            Action Description
          </h2>With the online class week winding down, the group took some time on this Saturday to pause and reflect on everything that had been accomplished over the past few days. On our own time and initiative, the members carried out a range of personal actions, from cooking a shared meal out of repurposed leftovers, riding the public bus for errands, tending to indoor plants, clearing out and sorting accumulated room waste, all the way to something as small but telling as finally throwing away a pile of hoarded scratch paper. Having a bit of breathing room at the end of the week gave us the chance to look back and appreciate that even amid a packed class schedule, we still found ways to show up for the cause.

          <div className="prose prose-green max-w-none">
            <p className="text-gray-800 mb-4"></p>
            <p className="text-gray-800">
              <strong>Key Findings from the Week: </strong>
              This week made one thing very clear: environmental stewardship doesn't have to be grand to be meaningful. Each action, taken on its own, might seem insignificant, but together they paint a picture of a group that is slowly but genuinely building environmental awareness into their everyday routines. The week also reinforced how much waste two people living together can unconsciously generate, and how conscious consumption starts with simply paying attention.

            </p>
            <p className="text-gray-800 mt-4">
              <strong>Group Meeting: </strong>
              Taking stock of the week, the team agreed that the most valuable takeaway wasn't any single action, but the shift in mindset that's starting to take root. We're becoming more observant, noticing the trash we generate, the choices we make when commuting, the food we almost let go to waste. The group also acknowledged that a busy academic schedule is a real barrier to consistency, and that it's okay for our actions to be small as long as they are intentional.

            </p>
            <p className="text-gray-800 mt-4">
              <strong>Recommendations: </strong>
              Moving forward, the team recommends establishing more consistent personal routines around waste management and mindful consumption, rather than relying on one-off cleanup sessions. Members are also encouraged to document their actions more proactively throughout the week so that synthesis days feel less like a scramble and more like a genuine reflection. The coming weekend also presents a good opportunity to observe household habits more closely, consumption, waste, energy use, and come back the following week with fresh observations and renewed momentum.
            </p>
          </div>
        </div>
