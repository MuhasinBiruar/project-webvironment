...
import img1 from '~/images/2026-03-31/1.jpg';
import img2 from '~/images/2026-03-31/2.jpg';
    ...
    <div className="min-h-screen bg-linear-to-br from-green-50 to-emerald-50">
      ...
      <div className="max-w-5xl mx-auto p-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          On this day, we found another trash in the classroom once we got in. We decided to have fun by throwing it together because we got tired of the fact that the classrooms always had random trash in them.
          ...
          <div className="prose prose-green max-w-none">
            ...
            <p className="text-gray-800 mt-4">
              <strong>Next Steps:</strong> Continue to maintain cleanliness in the classroom and encourage others to do the same.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-800">
              <strong>Notes:</strong> Having fun while maintaining cleanliness in the classroom can encourage others to do the same and create a more positive environment for everyone.
            </p>
          </div>
        </div>
